...
export interface SoulJourneyItem {
  title: string;
  subtitle: string;
  icon: string;
  content: string;
...
export const soulJourney: SoulJourneyItem[] = [
  {
...
export const retrogradePlanets: Record<string, { name: string; detail: string }> = {
  neptune: {
...
export const elementBalance: Record<string, BalanceItem> = {
  "Đất": {
    status: "Mạnh",
    icon: "🌱",
...
export const modalityBalance: Record<string, BalanceItem> = {
  "Tiên phong": {
    status: "Thiếu",
    icon: "⚡",
...
export const strongFactors: StrongFactor[] = [
  {
    name: "Mặt Trời",
    score: 64,
    rank: "★★★★★",
...
export const personalityProfile: PersonalityProfile = {
  mbti: "ESTJ",
