...
class LuckyColorInfo {
  final String name;
  final Color color;
  final String meaning;
  const LuckyColorInfo(this.name, this.color, this.meaning);
}

extension ZodiacSignExtension on ZodiacSign {
  LuckyColorInfo get luckyColorInfo {
    switch (this) {
      case ZodiacSign.aries:
        return const LuckyColorInfo(
            AppStrings.colorAries, Color(0xFFE53935), AppStrings.meaningAries);
      case ZodiacSign.taurus:
        return const LuckyColorInfo(
            AppStrings.colorTaurus, Color(0xFF43A047), AppStrings.meaningTaurus);
      case ZodiacSign.gemini:
        return const LuckyColorInfo(
            AppStrings.colorGemini, Color(0xFFFFD600), AppStrings.meaningGemini);
      case ZodiacSign.cancer:
        return const LuckyColorInfo(
            AppStrings.colorCancer, Color(0xFFB0BEC5), AppStrings.meaningCancer);
      case ZodiacSign.leo:
        return const LuckyColorInfo(
            AppStrings.colorLeo, Color(0xFFFBC02D), AppStrings.meaningLeo);
      case ZodiacSign.virgo:
        return const LuckyColorInfo(
            AppStrings.colorVirgo, Color(0xFFA1887F), AppStrings.meaningVirgo);
      case ZodiacSign.libra:
        return const LuckyColorInfo(
            AppStrings.colorLibra, Color(0xFFF48FB1), AppStrings.meaningLibra);
      case ZodiacSign.scorpio:
        return const LuckyColorInfo(
            AppStrings.colorScorpio, Color(0xFF880E4F), AppStrings.meaningScorpio);
      case ZodiacSign.sagittarius:
        return const LuckyColorInfo(AppStrings.colorSagittarius,
            Color(0xFF7B1FA2), AppStrings.meaningSagittarius);
      case ZodiacSign.capricorn:
        return const LuckyColorInfo(AppStrings.colorCapricorn,
            Color(0xFF1A237E), AppStrings.meaningCapricorn);
      case ZodiacSign.aquarius:
        return const LuckyColorInfo(AppStrings.colorAquarius, Color(0xFF00B8D4),
            AppStrings.meaningAquarius);
      case ZodiacSign.pisces:
        return const LuckyColorInfo(
            AppStrings.colorPisces, Color(0xFFB39DDB), AppStrings.meaningPisces);
    }
  }
